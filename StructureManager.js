module.exports = {
    ...
    buildLocal: function(room) {
        ...
        const controllerPath = room.findPath(startPos, room.controller.pos, { range: 1, swampCost: 1, ignoreCreeps: true, costCallback: function() { return costs; } });
        ...
        for (let sourceID of room.memory.resources.sources) {
            ...
            sourcePaths.push(
                room.findPath(startPos, source.pos, { range: 1, swampCost: 1, ignoreCreeps: true, costCallback: function() { return costs; } })
            )
        }
        ...
        for (let mineralID of room.memory.resources.minerals) {
            ...
            mineralPaths.push(
                room.findPath(startPos, mineral.pos, { range: 1, swampCost: 1, ignoreCreeps: true, costCallback: function() { return costs; } })
            )
        }
